...
public class ProcessingOrders extends JFrame {
    ...
    public ProcessingOrders() {
        ...
        tblProcessingOrders.getTableHeader().setBackground(new Color(216, 216, 216));
        tblProcessingOrders.getTableHeader().setFont(new Font("", 1, 17));        
        tblProcessingOrders.setRowHeight(30);        
        tblProcessingOrders.setFont(new Font("", 1, 15));   
